...
```
  ...
  |                                                                   |
  |  TETO DE MATERIA-PRIMA: paginando o indice de noticias, seca      |
  |  depois de ~26 itens (13, 13, 4, 4, 4). Aumentar config nao cria  |
  |  noticia que nao existe. O produto entrega "o que a imprensa      |
  |  publicou", nao "a criminalidade da cidade".                      |
  +==================================================================+
