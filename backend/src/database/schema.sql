...
INSERT INTO system_config (key, value, description, category, value_type) VALUES
  ...
  ('manual_search_max_results_30d', '50', 'BASE de artigos analisados na busca manual (equivale a 30 dias). Outros periodos escalam por raiz quadrada, sem faixas', 'pipeline', 'number'),
